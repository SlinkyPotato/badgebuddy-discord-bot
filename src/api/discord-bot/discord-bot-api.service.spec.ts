...
describe('GuildsApiService', () => {
  ...
  describe('getGuild', () => {
    it('should be defined', () => {
      expect(service.getDiscordBotSettings).toBeDefined();
    });
    ...
    it('should call service.getGuild() and return GetGuildResponseDto', async () => {
      ...
      const result: GetGuildResponseDto = await service.getDiscordBotSettings(mockRequest);
    ...
    it('should throw axios error', async () => {
      ...
      try {
        await service.getDiscordBotSettings(mockRequest);
      } catch (e) {
